class Statistics():
    ...
    def output_episode_stats(self, sso, exploration_rate):
        self.get_current_episode().output_episode_stats(sso, exploration_rate, self.total_steps, self.total_stacks, self.train_count)
...
class Episode:
    ...
    def output_episode_stats(self, sso, exploration_rate, total_steps, total_stacks, total_train):
        self.win = "WIN" in sso.gameWinner
        print(
            "{}. Win: {} | "
            "Tot. Reward: {:.3f} | "
            "Game Ticks: {:3d} | "
