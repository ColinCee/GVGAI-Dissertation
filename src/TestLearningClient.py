...
if __name__ == "__main__":
    ...
    parser.add_argument('-agentName', action="store", dest='agentName', default='QLearner.Agent')
    #parser.add_argument('-agentName', action="store", dest='agentName', default='QLearner-Test.Agent')
